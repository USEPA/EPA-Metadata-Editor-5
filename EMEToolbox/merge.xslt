...
<xslt:param name="replace" select="true()" />
...
-->
<xslt:param name="gpparam" />

<xslt:template match="*">
   <xslt:message>
      <xslt:text />Merging input with '<xslt:value-of select="$gpparam"/>
      <xslt:text>'</xslt:text>
   </xslt:message>
   <xslt:if test="string($gpparam)=''">
      <xslt:message terminate="yes">
   ...
   <xslt:call-template name="m:merge">
      ...
      <xslt:with-param name="nodes2" select="document($gpparam,/*)/node()" />
   </xslt:call-template>
</xslt:template>
